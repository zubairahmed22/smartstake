        ...
        <div className="container">
            <div className="section-header section-header--left">
                <div className="section-header__content">
                    ...
                    <a href="project.html" className="default-btn default-btn--small"><span>View all</span> </a>
                </div>
            </div>
                    ...
                    <div className="swiper-wrapper">
                            ...
                            <div className="project__item">
                                <div className="project__item-inner">
                                    <div className="project__item-thumb">
                                        ...
                                        <span className="badge"><img src="assets/images/chain/aval.png"
                                                alt="chain logo"/></span>
                                    </div>
                                    <div className="project__item-content">
                                        <div className="project__item-top">
                                            <div className="project__item-author">
                                                <a href="#"><img src="assets/images/igo/author/1.png"
                                                        alt="author image"/></a>
                                                <h4>Dexer Xone</h4>
                                            </div>
                                        ...
                                        <div className="project__item-bottom">
                                            ...
                                            <a href="project-details.html" className="default-btn default-btn--small">View
                                                Details</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="project__item">
                                <div className="project__item-inner">
                                    ...
                                    <div className="project__item-content">
                                        <div className="project__item-top">
                                            <div className="project__item-author">
                                                <a href="#"><img src="assets/images/igo/author/2.png"
                                                        alt="author image"/></a>
                                                <h4>DeFianXer 3dX</h4>
                                            </div>
                            ...
                            <div className="project__item">
                                <div className="project__item-inner">
                                    ...
                                    <div className="project__item-content">
                                        <div className="project__item-top">
                                            <div className="project__item-author">
                                                <a href="#"><img src="assets/images/igo/author/3.png"
                                                        alt="author image"/></a>
                                                <h4>Monster X</h4>
                                            </div>
                        ...
                        <div className="swiper-slide">
                            <div className="project__item">
                                <div className="project__item-inner">
                                    <div className="project__item-thumb">
                                        <img src="assets/images/igo/item/04.jpg" alt="IGO cover"/>
                                        <span className="badge"><img src="assets/images/chain/eth.png"
                                                alt="chain logo"/></span>
                                    </div>
                                    <div className="project__item-content">
                                        <div className="project__item-top">
                                            <div className="project__item-author">
                                                <a href="#"><img src="assets/images/igo/author/5.png"
                                                        alt="author image"/></a>
                                                <h4>Servora Dex</h4>
                                            </div>
                            ...
                            <div className="project__item">
                                <div className="project__item-inner">
                                    ...
                                    <div className="project__item-content">
                                        <div className="project__item-top">
                                            <div className="project__item-author">
                                                <a href="#"><img src="assets/images/igo/author/6.png"
                                                        alt="author image"/></a>
                                                <h4>DocR Chain</h4>
                                            </div>
