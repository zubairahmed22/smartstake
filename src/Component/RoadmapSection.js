        ...
        <div className="section-header section-header--middle">
            <div className="section-header__content">
                <div className="section-header__titlebar">
                    <p className="section-header__subtitle"> Explore</p>
                    <h2 className="section__header__title">Our Roadmap</h2>
                </div>
            </div>
        </div>
        <div className="roadmap__wrapper2">
            <div className="row gy-4 gy-md-0 gx-5">
                <div className="col-md-6">
                    <div className=" roadmap__item2 ms-md-4" data-aos="fade-right" >
...
and foster a cohesive $MART community.</p>
                            </div>
                            ...
                            <div className="roadmap__item2-content">
                                ...
                                <p>The backbone of any crypto project. Our focus is on developing
a robust, secure, and functional token smart contract, rigorously tested to prevent
vulnerabilities and ensure seamless transactions.</p>
                            </div>
...
influencers, and establish strategic partnerships to amplify our reach and impact.
</p>
                            </div>
...
system, ensuring the community that their investments are safeguarded.
...
CoinMarketCap, making it more accessible to potential holders globally.
...
extend the liquidity lock to 10 years. This monumental lock period is designed to curb any
investor apprehensions, emphasizing our focus on trust.
</p>
                            </div>
...
from our users and aligning with market trends to offer an unparalleled staking experience.
</p>
                            </div>
                    ...
                    <div className="roadmap__item2 ms-md-4" data-aos="fade-left">
                        <div className="roadmap__item2-inner">
                            <div className="roadmap__item2-content">
                                <div className="roadmap__item2-header">
                                    <h3>Q3, 2024</h3>
                                    <h4>NFT Integration & $MART Token Rewards Systems</h4>
                                    <p>NFT Creation</p>
                                </div>
                                <p>We'll channel our efforts into the meticulous design of NFTs, instilling unique metadata in each.</p>
                            ...
                            <div className="roadmap__item2-content">
                                ...
                                <p> Collaboration will be key as we work with developers to
create secure, efficient, and seamlessly integrated NFT smart contracts within our existing
blockchain architecture.</p>
                            ...
                            <div className="roadmap__item2-content">
                                ...
                                <p> We'll introduce our community to the exclusive NFT Minting DApp, a
place where digital art becomes tradable and collectible.</p>
                    ...
                    <div className="roadmap__item2 ms-auto me-md-4" data-aos="fade-right">
                        <div className="roadmap__item2-inner">
                            <div className="roadmap__item2-content">
                                <div className="roadmap__item2-header">
                                    <h3>Q4, 2024</h3>
                                    <h4>Market Expansion & NFT Staking Platform Realization</h4>
                                    <p>Development of the NFT Staking DApp</p>
                                </div>
                                <p>Development of a cutting-edge NFT Staking DApp,
allowing users to stake NFTs for rewards within a tiered reward system, encouraging longterm staking and active participation.</p>
                            </div>
...
with exchanges, marketplaces, and influencers that will take the $MART brand global.
                            ...
                            <div className="roadmap__item2-content">
                                ...
                                <p>Build a seamless user experience to ensure our NFT ecosystem
achieves cross-platform compatibility, ensuring every user enjoys a responsive and interactive
journey on desktop and mobile.</p>
                             ...
                             <div className="roadmap__item2-content">
                                ...
                                <p>Foster an active and engaged community through
regular updates, AMAs (Ask Me Anything), and community-driven events. Encourage usergenerated content,
 such as fan art and collectible suggestions, to enhance community
involvement.</p>
                            ...
                            <div className="roadmap__item2-content">
                                ...
                                <p>Facilitate the onboarding of talented artists and creators to the
platform. Provide resources and support to assist them in creating compelling and marketable
NFT collections.
</p>
